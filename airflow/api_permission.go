...
func (r PermissionApiApiGetPermissionsRequest) Execute() (*ActionCollection, *http.Response, error) {
...
func (a *PermissionApiService) GetPermissionsExecute(r PermissionApiApiGetPermissionsRequest) (*ActionCollection, *http.Response, error) {
	var (
