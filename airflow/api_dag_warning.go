...
func (r DagWarningApiApiGetDagWarningsRequest) Execute() (*DagWarningCollection, *http.Response, error) {
...
*/
func (a *DagWarningApiService) GetDagWarnings(ctx context.Context) DagWarningApiApiGetDagWarningsRequest {
	return DagWarningApiApiGetDagWarningsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DagWarningApiService) GetDagWarningsExecute(r DagWarningApiApiGetDagWarningsRequest) (*DagWarningCollection, *http.Response, error) {
	var (
