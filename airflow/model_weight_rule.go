...
func (v *WeightRule) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid WeightRule", value)
}

// NewWeightRuleFromValue returns a pointer to a valid WeightRule
...
func NewNullableWeightRule(val *WeightRule) *NullableWeightRule {
	return &NullableWeightRule{value: val, isSet: true}
}
