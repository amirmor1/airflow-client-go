...
func (v *DagState) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid DagState", value)
}

// NewDagStateFromValue returns a pointer to a valid DagState
...
func NewNullableDagState(val *DagState) *NullableDagState {
	return &NullableDagState{value: val, isSet: true}
}
