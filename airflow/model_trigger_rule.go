...
func (v *TriggerRule) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid TriggerRule", value)
}

// NewTriggerRuleFromValue returns a pointer to a valid TriggerRule
...
func NewNullableTriggerRule(val *TriggerRule) *NullableTriggerRule {
	return &NullableTriggerRule{value: val, isSet: true}
}
