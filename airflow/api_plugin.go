...
func (r PluginApiApiGetPluginsRequest) Execute() (*PluginCollection, *http.Response, error) {
...
*/
func (a *PluginApiService) GetPlugins(ctx context.Context) PluginApiApiGetPluginsRequest {
	return PluginApiApiGetPluginsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PluginApiService) GetPluginsExecute(r PluginApiApiGetPluginsRequest) (*PluginCollection, *http.Response, error) {
	var (
