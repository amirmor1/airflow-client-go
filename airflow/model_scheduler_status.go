...
func (o *SchedulerStatus) SetStatusNil() {
	o.Status.Set(nil)
}
...
// GetLatestSchedulerHeartbeatOk returns a tuple with the LatestSchedulerHeartbeat field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *SchedulerStatus) HasLatestSchedulerHeartbeat() bool {
	if o != nil && o.LatestSchedulerHeartbeat.IsSet() {
		return true
	}
...
func (o *SchedulerStatus) SetLatestSchedulerHeartbeatNil() {
	o.LatestSchedulerHeartbeat.Set(nil)
}
...
func (o *SchedulerStatus) UnsetLatestSchedulerHeartbeat() {
	o.LatestSchedulerHeartbeat.Unset()
}
...
func (o SchedulerStatus) MarshalJSON() ([]byte, error) {
	...
	if o.LatestSchedulerHeartbeat.IsSet() {
...
func NewNullableSchedulerStatus(val *SchedulerStatus) *NullableSchedulerStatus {
	return &NullableSchedulerStatus{value: val, isSet: true}
}
