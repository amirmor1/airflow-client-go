...
func (r UserApiApiGetUserRequest) Execute() (*UserCollectionItem, *http.Response, error) {
...
func (a *UserApiService) GetUserExecute(r UserApiApiGetUserRequest) (*UserCollectionItem, *http.Response, error) {
	var (
...
func (r UserApiApiGetUsersRequest) Execute() (*UserCollection, *http.Response, error) {
...
func (a *UserApiService) GetUsersExecute(r UserApiApiGetUsersRequest) (*UserCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r UserApiApiPatchUserRequest) Execute() (*UserCollectionItem, *http.Response, error) {
...
*/
func (a *UserApiService) PatchUser(ctx context.Context, username string) UserApiApiPatchUserRequest {
	return UserApiApiPatchUserRequest{
		ApiService: a,
		ctx: ctx,
		username: username,
...
// Execute executes the request
//  @return UserCollectionItem
func (a *UserApiService) PatchUserExecute(r UserApiApiPatchUserRequest) (*UserCollectionItem, *http.Response, error) {
	var (
...
func (r UserApiApiPostUserRequest) Execute() (*User, *http.Response, error) {
...
*/
func (a *UserApiService) PostUser(ctx context.Context) UserApiApiPostUserRequest {
	return UserApiApiPostUserRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return User
func (a *UserApiService) PostUserExecute(r UserApiApiPostUserRequest) (*User, *http.Response, error) {
	var (
