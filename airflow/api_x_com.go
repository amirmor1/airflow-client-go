...
func (r XComApiApiGetXcomEntriesRequest) MapIndex(mapIndex int32) XComApiApiGetXcomEntriesRequest {
	r.mapIndex = &mapIndex
	return r
}
// Only filter the XCom records which have the provided key.
func (r XComApiApiGetXcomEntriesRequest) XcomKey(xcomKey string) XComApiApiGetXcomEntriesRequest {
	r.xcomKey = &xcomKey
	return r
}
...
func (r XComApiApiGetXcomEntriesRequest) Execute() (*XComCollection, *http.Response, error) {
...
func (a *XComApiService) GetXcomEntriesExecute(r XComApiApiGetXcomEntriesRequest) (*XComCollection, *http.Response, error) {
	var (
	...
	if r.xcomKey != nil {
		localVarQueryParams.Add("xcom_key", parameterToString(*r.xcomKey, ""))
	}
	if r.limit != nil {
...
// Filter on map index for mapped task.
func (r XComApiApiGetXcomEntryRequest) MapIndex(mapIndex int32) XComApiApiGetXcomEntryRequest {
	r.mapIndex = &mapIndex
	return r
}
...
func (r XComApiApiGetXcomEntryRequest) Execute() (*XCom, *http.Response, error) {
...
*/
func (a *XComApiService) GetXcomEntry(ctx context.Context, dagId string, dagRunId string, taskId string, xcomKey string) XComApiApiGetXcomEntryRequest {
	return XComApiApiGetXcomEntryRequest{
		ApiService: a,
		ctx: ctx,
		dagId: dagId,
...
// Execute executes the request
//  @return XCom
func (a *XComApiService) GetXcomEntryExecute(r XComApiApiGetXcomEntryRequest) (*XCom, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
