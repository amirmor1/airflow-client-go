...
func (r EventLogApiApiGetEventLogRequest) Execute() (*EventLog, *http.Response, error) {
...
*/
func (a *EventLogApiService) GetEventLog(ctx context.Context, eventLogId int32) EventLogApiApiGetEventLogRequest {
	return EventLogApiApiGetEventLogRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return EventLog
func (a *EventLogApiService) GetEventLogExecute(r EventLogApiApiGetEventLogRequest) (*EventLog, *http.Response, error) {
	var (
...
func (r EventLogApiApiGetEventLogsRequest) Execute() (*EventLogCollection, *http.Response, error) {
...
func (a *EventLogApiService) GetEventLogsExecute(r EventLogApiApiGetEventLogsRequest) (*EventLogCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
