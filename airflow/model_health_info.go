...
func (o *HealthInfo) GetMetadatabase() MetadatabaseStatus {
	if o == nil || o.Metadatabase == nil {
		var ret MetadatabaseStatus
		return ret
	}
	return *o.Metadatabase
}

// GetMetadatabaseOk returns a tuple with the Metadatabase field value if set, nil otherwise
...
// GetTriggerer returns the Triggerer field value if set, zero value otherwise.
func (o *HealthInfo) GetTriggerer() TriggererStatus {
	if o == nil || o.Triggerer == nil {
		var ret TriggererStatus
		return ret
	}
	return *o.Triggerer
}

// GetTriggererOk returns a tuple with the Triggerer field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTriggerer gets a reference to the given TriggererStatus and assigns it to the Triggerer field.
...
func (o *HealthInfo) GetDagProcessor() DagProcessorStatus {
	if o == nil || o.DagProcessor == nil {
		var ret DagProcessorStatus
		return ret
	}
...
// SetDagProcessor gets a reference to the given DagProcessorStatus and assigns it to the DagProcessor field.
