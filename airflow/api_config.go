...
func (r ConfigApiApiGetConfigRequest) Section(section string) ConfigApiApiGetConfigRequest {
	r.section = &section
	return r
}

func (r ConfigApiApiGetConfigRequest) Execute() (*Config, *http.Response, error) {
...
//  @return Config
func (a *ConfigApiService) GetConfigExecute(r ConfigApiApiGetConfigRequest) (*Config, *http.Response, error) {
	var (
...
type ConfigApiApiGetValueRequest struct {
	ctx context.Context
	ApiService *ConfigApiService
	section string
	option string
...
func (r ConfigApiApiGetValueRequest) Execute() (*Config, *http.Response, error) {
	return r.ApiService.GetValueExecute(r)
}
...
GetValue Get a option from configuration
 ...
 @param section
 @param option
 @return ConfigApiApiGetValueRequest
*/
func (a *ConfigApiService) GetValue(ctx context.Context, section string, option string) ConfigApiApiGetValueRequest {
	return ConfigApiApiGetValueRequest{
		ApiService: a,
		ctx: ctx,
		section: section,
...
// Execute executes the request
//  @return Config
func (a *ConfigApiService) GetValueExecute(r ConfigApiApiGetValueRequest) (*Config, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigApiService.GetValue")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/config/section/{section}/option/{option}"
	localVarPath = strings.Replace(localVarPath, "{"+"section"+"}", url.PathEscape(parameterToString(r.section, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"option"+"}", url.PathEscape(parameterToString(r.option, "")), -1)
