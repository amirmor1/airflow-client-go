...
func (r MonitoringApiApiGetHealthRequest) Execute() (*HealthInfo, *http.Response, error) {
...
*/
func (a *MonitoringApiService) GetHealth(ctx context.Context) MonitoringApiApiGetHealthRequest {
	return MonitoringApiApiGetHealthRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return HealthInfo
func (a *MonitoringApiService) GetHealthExecute(r MonitoringApiApiGetHealthRequest) (*HealthInfo, *http.Response, error) {
	var (
...
func (r MonitoringApiApiGetVersionRequest) Execute() (*VersionInfo, *http.Response, error) {
...
*/
func (a *MonitoringApiService) GetVersion(ctx context.Context) MonitoringApiApiGetVersionRequest {
	return MonitoringApiApiGetVersionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return VersionInfo
func (a *MonitoringApiService) GetVersionExecute(r MonitoringApiApiGetVersionRequest) (*VersionInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
