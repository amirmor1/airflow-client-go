...
func (r DatasetApiApiGetDatasetRequest) Execute() (*Dataset, *http.Response, error) {
...
//  @return Dataset
func (a *DatasetApiService) GetDatasetExecute(r DatasetApiApiGetDatasetRequest) (*Dataset, *http.Response, error) {
	var (
...
func (r DatasetApiApiGetDatasetEventsRequest) Execute() (*DatasetEventCollection, *http.Response, error) {
...
*/
func (a *DatasetApiService) GetDatasetEvents(ctx context.Context) DatasetApiApiGetDatasetEventsRequest {
	return DatasetApiApiGetDatasetEventsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DatasetApiService) GetDatasetEventsExecute(r DatasetApiApiGetDatasetEventsRequest) (*DatasetEventCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DatasetApiApiGetDatasetsRequest) Execute() (*DatasetCollection, *http.Response, error) {
...
func (a *DatasetApiService) GetDatasetsExecute(r DatasetApiApiGetDatasetsRequest) (*DatasetCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DatasetApiApiGetUpstreamDatasetEventsRequest) Execute() (*DatasetEventCollection, *http.Response, error) {
...
*/
func (a *DatasetApiService) GetUpstreamDatasetEvents(ctx context.Context, dagId string, dagRunId string) DatasetApiApiGetUpstreamDatasetEventsRequest {
	return DatasetApiApiGetUpstreamDatasetEventsRequest{
		ApiService: a,
		ctx: ctx,
		dagId: dagId,
...
// Execute executes the request
//  @return DatasetEventCollection
func (a *DatasetApiService) GetUpstreamDatasetEventsExecute(r DatasetApiApiGetUpstreamDatasetEventsRequest) (*DatasetEventCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
