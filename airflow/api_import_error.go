...
func (r ImportErrorApiApiGetImportErrorRequest) Execute() (*ImportError, *http.Response, error) {
...
*/
func (a *ImportErrorApiService) GetImportError(ctx context.Context, importErrorId int32) ImportErrorApiApiGetImportErrorRequest {
	return ImportErrorApiApiGetImportErrorRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return ImportError
func (a *ImportErrorApiService) GetImportErrorExecute(r ImportErrorApiApiGetImportErrorRequest) (*ImportError, *http.Response, error) {
	var (
...
func (r ImportErrorApiApiGetImportErrorsRequest) Execute() (*ImportErrorCollection, *http.Response, error) {
...
*/
func (a *ImportErrorApiService) GetImportErrors(ctx context.Context) ImportErrorApiApiGetImportErrorsRequest {
	return ImportErrorApiApiGetImportErrorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ImportErrorApiService) GetImportErrorsExecute(r ImportErrorApiApiGetImportErrorsRequest) (*ImportErrorCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
