...
func (r ProviderApiApiGetProvidersRequest) Execute() (*ProviderCollection, *http.Response, error) {
...
*/
func (a *ProviderApiService) GetProviders(ctx context.Context) ProviderApiApiGetProvidersRequest {
	return ProviderApiApiGetProvidersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ProviderApiService) GetProvidersExecute(r ProviderApiApiGetProvidersRequest) (*ProviderCollection, *http.Response, error) {
	var (
